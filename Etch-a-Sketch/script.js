    ...
    while (colCounter < colNumber) {
        ...
        while (rowCounter < rowNumber) {
            if (colCounter == 0 && rowCounter == 0 ) {
                var rowHTML = ' <div class="db_cell db_cell_11 color11""></div>\n';
            } 
            else if (colCounter == 0 && rowCounter == rowNumber - 1) {
                var rowHTML = ' <div class="db_cell db_cell_1rn color11""></div>\n';
            }
            else if (colCounter == colNumber - 1 && rowCounter == 0 ) {
                var rowHTML = ' <div class="db_cell db_cell_cn1 color11""></div>\n';
            } 
            else if (colCounter == colNumber - 1 && rowCounter == rowNumber - 1) {
                var rowHTML = ' <div class="db_cell db_cell_cnrn color11""></div>\n';
            }
            else {
                var rowHTML = ' <div class="db_cell color11""></div>\n';
            }
...
function saveBoard () {
    html2canvas(document.getElementById("widget")).then( canvas => {
...
var saveBoardBtn = document.getElementById('saveBoard');
